...
public interface IDialogService
{
    ...
    void OpenPopup<TContent>(TContent content, Action<Popup>? configure = null) where TContent : Control;
    void ClosePopup<TContent>(TContent content) where TContent : Control;
    ...
    Task<IPopupHandle> ShowPopupAsync<TContent>(TContent content, Action<Popup>? configure = null, CancellationToken cancellationToken = default) where TContent : Control;
